...
function cards() {
    ...
    // Второй вариант getResource (создания карточек меню)
...
function forms(formSelector, modalTimerId) {
    ...
    //Красивое оповещение пользователя после заполнения формы
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2023-09-01');
